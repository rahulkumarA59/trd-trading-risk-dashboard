  ...
  return (
    <div className="min-h-screen bg-[#070C18] flex relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div
          className="absolute w-[600px] h-[600px] -top-48 -left-48 rounded-full opacity-20 animate-pulse"
          style={{ background: 'radial-gradient(circle, #3B82F6 0%, transparent 70%)', animationDuration: '8s' }}
        />
        <div
          className="absolute w-[500px] h-[500px] -bottom-48 -right-48 rounded-full opacity-15 animate-pulse"
          style={{ background: 'radial-gradient(circle, #8B5CF6 0%, transparent 70%)', animationDuration: '10s' }}
        />
        <div
          className="absolute w-[400px] h-[400px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full opacity-10 animate-pulse"
        ...
        <div className="relative z-10 flex flex-col justify-center w-full max-w-lg mx-auto px-10 xl:px-6">
          ...
          <div className="flex items-center gap-3 mb-10 group">
            <div className="relative">
              ...
              <div className="relative w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/30 transform group-hover:scale-105 transition-transform duration-300">
          ...
          <div className="space-y-4 mb-10">
            ...
            <p className="text-slate-400 text-lg max-w-md leading-relaxed">
              Real-time portfolio tracking, AI-powered predictions, and comprehensive risk analysis — all in one dashboard.
            </p>
          </div>
          ...
          <div className="flex gap-5 mb-12">
            {[
              { icon: TrendingUp, label: 'Real-time Analytics', color: 'text-green-400' },
          ...
          <div className="flex gap-4">
            {[
              ...
              <div
                key={i}
                className="bg-slate-800/20 backdrop-blur-sm border border-slate-700/30 rounded-2xl px-5 py-4 hover:bg-slate-800/40 hover:border-slate-600/50 transition-all duration-300 cursor-default group"
              >
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
        <div className="w-full max-w-[420px] relative">
          ...
          {/* Outer glow */}
          <div className="absolute -inset-px bg-gradient-to-r from-blue-500/30 to-cyan-500/30 rounded-2xl blur-2xl opacity-60" />
          ...
          <div className="relative bg-[#0D1526]/80 backdrop-blur-2xl border border-slate-700/60 rounded-2xl shadow-[0_32px_64px_rgba(0,0,0,0.6)] p-8">
            ...
            <button
              type="button"
              className="w-full mb-6 p-3 bg-slate-800/60 border border-slate-700/60 rounded-xl flex items-center justify-center gap-3 hover:bg-slate-700/60 hover:border-slate-600 transition-all duration-200 group"
            >
              <div className="w-9 h-9 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                <Fingerprint className="w-4 h-4 text-blue-400" />
              </div>
              <span className="text-sm text-slate-300 font-medium">Login with Passkey</span>
            </button>
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center">
                <span className="px-3 text-[11px] uppercase tracking-widest text-slate-500 bg-[#0D1526]">
                  or continue with
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 cursor-pointer group select-none">
                  <input
                    ...
                    className="w-4 h-4 rounded border-slate-600 bg-slate-800 accent-blue-500 cursor-pointer focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-0"
                  />
